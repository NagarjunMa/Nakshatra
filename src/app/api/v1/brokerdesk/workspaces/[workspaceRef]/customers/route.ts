...
import { CustomerInvitationError, resolveBrokerdeskCustomers } from "@/features/broker-relationships/server/customer-invitation.service";
...
export async function GET(request: Request, context: Context) {
  ...
  try {
    ...
    const result = await resolveBrokerdeskCustomers(auth.supabase, workspaceRef);
    ...
    logServerError("brokerdesk.customers_read_failed", requestId, error);
