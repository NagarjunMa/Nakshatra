...
insert into public.broker_clients (organization_id, candidate_id, introduced_by, starts_at)
values
  ('83000000-0000-4000-8000-000000000001', '84000000-0000-4000-8000-000000000001', '81000000-0000-4000-8000-000000000003', now() - interval '1 day'),
  ('83000000-0000-4000-8000-000000000001', '84000000-0000-4000-8000-000000000002', '81000000-0000-4000-8000-000000000003', now() - interval '1 day'),
  ('83000000-0000-4000-8000-000000000002', '84000000-0000-4000-8000-000000000001', '81000000-0000-4000-8000-000000000004', now() - interval '1 day'),
  ('83000000-0000-4000-8000-000000000002', '84000000-0000-4000-8000-000000000002', '81000000-0000-4000-8000-000000000004', now() - interval '1 day');
